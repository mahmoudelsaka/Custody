...
class CustodyEquipment(models.Model):
    ...
    item_ids = fields.One2many(comodel_name="equipment.item.line", inverse_name="equip_id", required=False, )
...
class EquipmentItemLINE(models.Model):
    ...
    _rec_name = 'item_id'
    item_id = fields.Many2one(comodel_name="equipment.item", required=False, )
    code_id = fields.Char(string="ID",related="item_id.code")
    value_id = fields.Char(string="Value")
    equip_id = fields.Many2one(comodel_name="custody.equipment", string="Equipment", required=False, )